...
def prediction_data():
    ...
    pipeline_predicition = PredictionPipeline()
    pred = pipeline_predicition.predict(final_data)
    ...
    if result == 0 :
        ...
        return render_template('results.html', final_result = 'Your Yearly Income is More than or Equal to 50k:{}'.format(result))
